...
function Home() {
  ...
  // Check if it's mobile view (for 3D effects only)
  useEffect(() => {
  ...
  // Auto-play video always (both mobile and desktop)
  useEffect(() => {
    if (!videoRef.current || !isVideoLoaded || videoError) return

    // Always try to play the video when it's loaded
  ...
  const handleMouseEnter = () => {
    // Only handle 3D effects on desktop (larger screens)
    ...
    // Video is always playing, no need to start it on hover
  }
  ...
  const handleMouseLeave = () => {
    ...
    // Video continues playing, no need to pause on mouse leave
  }
      ...
      <section className="hero">
        ...
        <div className="container">
          ...
          >
            ...
            >
              {/* Hero media - Video always visible and playing */}
              <div className="hero-media-wrapper">
                {/* Pexels video - always shown and playing */}
                <video 
                  ref={videoRef}
                  muted
                  loop
              ...
              <div className="hero-video-overlay"
                style={{
                  ...
                  transition: isHovering && hasInitialized ? 'none' : 'transform 0.8s cubic-bezier(0.4, 0, 0.2, 1)',
                  opacity: isHovering ? 0 : 1 // Hide overlay only on hover (desktop)
                }}
              >
                <motion.div
